...
Classes[6] = {NAME = "Support", SPEED = 500, WEAPON_SET = 6, HEALTH = 90, AMMO = {13}, MODEL = "models/player/Group03/Female_04.mdl", DSCR = "A must have for those who enjoy setting fire to things. The pyro has the ability to set fire traps and explosions to send those enemies fliying!"  }
